...
class Category(db.Model):
    ...
    advertise = db.relationship('Advertise' , backref=db.backref('category', lazy=True))
...
class Advertise(db.Model):
    ...
    carts = db.relationship('Cart' , backref=db.backref('advertise', lazy=True))
    orders = db.relationship('Order' , backref=db.backref('advertise', lazy=True))
